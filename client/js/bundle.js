...
App = React.createClass({displayName: "App",
	...
	render: function () {
		return React.createElement("section", {className: "layout-container"}, 
			React.createElement("div", {className: "main-column"}, 
				React.createElement(Header, null), 
				React.createElement(CommentBox, null)
			), 
			React.createElement("div", {className: "info-column"}
...
},{"./components/comments":2,"./components/footer":3,"./components/header":4,"react":161}],2:[function(require,module,exports){
		...
		return (
			React.createElement("div", {className: "messages-container"}, 
				...
				React.createElement("div", {className: "message-form-container"}, 
					React.createElement(Typist, {author: this.state.typist}), 
					React.createElement(CommentForm, {submitComment: this.submitComment, handleTyping: this.handleTyping})
				)
			)
		);
	}
	...
	render: function () {
		...
		return (
			React.createElement("div", {className: "message-list"}, 
				React.createElement("div", {className: "inner-container"}, Comments)
			)
		);
	}
});
		...
		return (
			React.createElement("div", {className:  msgClass }, 
				React.createElement("div", {className: "message-block"}, 
					React.createElement("h5", {hidden: true}, this.props.comment.author), 
					React.createElement("p", null, this.props.comment.text)
				)
			)
		);
	}
	...
	render: function () {
			return (
				React.createElement("div", {className: "notification-container"}, 
					this.props.notification && React.createElement("p", null, this.props.notification)
				)
			);
	}
});

var Typist = React.createClass({displayName: "Typist",
	render: function () {
			return (
				React.createElement("div", {className: "typing"}, 
						this.props.author && React.createElement("span", {className: "author"}, this.props.author, " is typing...")
				)
			);
	}
});
...
var CommentForm = React.createClass({displayName: "CommentForm",
	...
	render: function () {
		return (
			...
			React.createElement("form", {className: "message-form", onSubmit: this.handleSubmit}, 
				this.state.author ? React.createElement("p", null, this.state.author, ":") : React.createElement("input", {type: "text", name: "author", ref: "author", placeholder: "Hi! What's your name?", required: true}), 
				React.createElement("section", {className: "message-submit"}, 
					React.createElement("div", null, 
						React.createElement("input", {type: "text", name: "text", ref: "text", placeholder: "Message...", required: true, onChange: this.onChange})
					), 
					React.createElement("div", null, 
						React.createElement("button", {type: "submit", ref: "submitButton"})
					)
				)
			)
			)
...
},{"jquery":6,"react":161}],3:[function(require,module,exports){
        ...
        return React.createElement("footer", {className: "footer"}, 
            React.createElement("div", {className: "container"}, 
                React.createElement("ul", null, 
                    React.createElement("li", null, "i am"), 
                    React.createElement("li", null, "the"), 
                    React.createElement("li", null, "walrus")
                )
            )
        )
    }
...
Header = React.createClass({displayName: "Header",
    render: function () {
        return React.createElement("header", {className: "banner"}, 
            React.createElement("div", {className: "inner-container"}, 
                React.createElement("h1", null, 
                    React.createElement("img", {src: "images/logo-rad.png", alt: "Radical"})
                )
            )
        )
    }
